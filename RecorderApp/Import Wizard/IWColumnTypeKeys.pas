{===============================================================================
  Unit:         IWColumnTypeKeys.pas

  Implements:   -

  Description:  Keys of column types for which special behaviour is defined.
...
const
  ...
  CT_KEY_REVIEWER_PREFFERED   = 'SYSTEM01000000G0';
